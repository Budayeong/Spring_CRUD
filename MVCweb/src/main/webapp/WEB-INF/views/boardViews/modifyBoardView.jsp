	...
	<form action="modifyProcBoard.do?seq=${board.seq}" method="post">
		<table border="1px solid gray" style="border-collaps:collapse;">
			...
			<tr align="center" height="50">
				<td width="200">제목</td>
				<td width="200">
					<input type="text" value="${board.title}" style="width: 700px;" name="title">
				</td>
			</tr>
			<tr align="center" height="50">
			...
			<tr align="center" height="50">
				<td width="200">내용</td>
				<td width="400">
					<textarea name="content" style="width:700px; height:50px;">${board.content}</textarea>	
				</td>
			</tr>
			<tr align="center" height="50">
				<td width="200">신청 기간</td>
				<td width="200">
					<input type="text" value="${board.time}" style="width: 700px;" name="time">
				</td>
			</tr>
			<tr align="center" height="50">
				<td width="200">신청 마감</td>
				<td width="200">
					<input type="date" value="${board.endtime}" style="width: 700px;" name="endtime">
				</td>
			</tr>
			<tr align="center" height="50">
				<td width="200">신청 사이트</td>
				<td width="200">
					<input type="text" style="width: 700px;" value="${board.webname}" name="webname">
                    <input type="text" style="width: 700px;" value="${board.website}" name="website">
				</td>
			</tr>
			<tr align="center" height="50">
				<td colspan="2">
